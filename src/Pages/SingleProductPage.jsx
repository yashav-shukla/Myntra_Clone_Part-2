...
import { getKidsSingleProductAPI, getSingleProductAPI, getWomensSingleProductAPI } from "../Redux/Product/Product.api";
...
const SingleProductPage = () => {
  ...
  const handleAddToWishlist = async () => {
    ...
    await axios
      .post(`https://Myntra.onrender.com/WishList/`, singleProduct)
  ...
  const AddtoBag = async () => {
    // console.log("newItem:",props)
    await axios
      .post(`https://Myntra.onrender.com/cart/`, singleProduct)
      .then((res) => {
